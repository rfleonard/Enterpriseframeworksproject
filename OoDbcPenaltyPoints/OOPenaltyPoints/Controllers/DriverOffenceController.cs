...
namespace OOPenaltyPoints.Controllers
{
    public class DriverOffenceController : Controller
    {
        ...
        public ActionResult Statistics()
        {
            ...
            doStats.Add(new SelectListItem
            {
                Text = "Penalty Points Incurred Per Driver",
                Value = "Driver"
            });
            doStats.Add(new SelectListItem
            {
        ...
        {
            if (index == 1)
                ViewBag.Message = _BLL.StatisticsOffence();
            else if (index == 2)
                ViewBag.Message = _BLL.StatisticsDriver();
            else if (index == 3)
                ViewBag.Message = _BLL.StatisticsLicence();
            else if (index == 4)
                return View();
        ...
        {
            if (index == 1)
                ViewBag.Message =  _BLL.NewOffenceNotification();
            else if (index == 2)
               ViewBag.Message = _BLL.A28DaysNotification();
            else if (index == 3)
                ViewBag.Message = _BLL.A56DayNotification();
            else if (index == 4)
                ViewBag.Message =  _BLL.DisqualificationNotification();
            else if (index == 5)
                ViewBag.Message = _BLL.A3YearDeleteNotification();
